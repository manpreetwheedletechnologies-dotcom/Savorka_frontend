...
function DetailRow({ label, value }) {
  return (
    <div className="grid grid-cols-[78px_1fr] gap-3 text-[14px] sm:text-[15px]">
      <p className="text-[#7f8ba1] font-medium">{label}</p>
      <p className="text-[#1f1f1f] font-medium break-words">{value || "-"}</p>
    </div>
  );
}
...
function ConfirmDetailsPopup({ data, onConfirm, onEdit }) {
  return (
    <div className="absolute inset-0 z-20 flex items-center justify-center bg-black/10 px-3">
      <div className="w-full max-w-[310px] rounded-[24px] border border-[#d5dfeb] bg-[#DBEC25] p-5 shadow-[0_16px_40px_rgba(0,0,0,0.18)]">
        <h3 className="mb-5 text-center text-[18px] font-bold text-[#1d67b3]">
        ...
        <div className="space-y-3">
          ...
          <DetailRow label="Phone" value={data.mobile} />
        ...
        <div className="mt-6 flex items-center gap-3">
          <button
            type="button"
            onClick={onEdit}
            className="flex-1 rounded-[18px] border border-[#cfd5df] bg-white px-4 py-3 text-[14px] font-medium text-[#333] shadow-sm transition hover:bg-[#f3f3f3]"
          >
            Edit
          </button>
          ...
          <button
            type="button"
            onClick={onConfirm}
            className="flex-1 rounded-[18px] bg-[#5b97d4] px-4 py-3 text-[14px] font-semibold text-white shadow-sm transition hover:opacity-95"
          >
            Confirm
          </button>
        </div>

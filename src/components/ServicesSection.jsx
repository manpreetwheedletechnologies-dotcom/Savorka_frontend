  ...
  return (
    <section
      ...
      style={{
        ...
        background: "linear-gradient(to bottom, #e8e5de 15%, #dce8c4 45%)",
        overflow: "hidden",
      }}
    >
      {/* Background */}
      ...
      >
        <div className="servicesGrid">
          <ServiceCard {...SERVICES[0]} radius="20px" />
          <ServiceCard {...SERVICES[1]} radius="80px 20px 20px 20px" />
          <ServiceCard {...SERVICES[2]} radius="90px 20px 80px 20px" />
          <ServiceCard {...SERVICES[3]} radius="20px" />
        </div>
      </div>

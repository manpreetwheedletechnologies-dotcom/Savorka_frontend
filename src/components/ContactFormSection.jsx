...
const ContactFormSection = () => {
  ...
  const validateSingleField = (field, value) => {
    ...
    switch (field) {
      ...
      case "commercialBill":
        if (activeTab === 2) {
          if (!trimmed) return "Monthly Bill is required.";
        }
        return "";
      ...
      case "selectedBill":
        if (activeTab === 0 && selectedBill === null) {
          return "Please select your Average Monthly Bill.";
        }
        return "";
    ...
    >
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-10">
        ...
        <div
          ...
          style={{ width: "5px", backgroundColor: "#ffffff" }}
        />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={getInputClass(
                      "name",
                      "w-full mt-1 px-3 py-2 rounded-lg text-xs md:text-sm bg-white border outline-none"
                    )}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (touched.societyName) {
                        setErrors((prev) => ({
                          ...prev,
                          societyName: validateSingleField(
                            "societyName",
                            e.target.value
                          ),
                        }));
                    ...
                    className={getInputClass(
                      "societyName",
                      "w-full mt-1 px-3 py-2 rounded-lg bg-white border outline-none"
                    )}
                  />
              ...
              <div className="grid grid-cols-2 md:grid-cols-1 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleFieldChange("commercialBill", e.target.value)
                    }
              ...
              <div className="grid grid-cols-2 md:grid-cols-1 gap-3">
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      if (touched.monthlyBill) {
                        setErrors((prev) => ({
                          ...prev,
                          monthlyBill: validateSingleField(
                            "monthlyBill",
                            e.target.value
                          ),
                        }));
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="No AGM approval yet">
                      No AGM approval yet
                    </option>
                  ...
                  onChange={(e) => {
                    ...
                    setErrors((prev) => ({
                      ...
                      agreed: e.target.checked
                        ? ""
                        : "Please agree to the Terms of Service & Policies.",
                    }));
                  }}
